...
sheet.write(1, 0, "Target FragID", style)
sheet.write(1, 1, "Target Section/Subsection", style)
sheet.write(1, 2, "Source Section/Subsection", style)
sheet.write(1, 3, "Source Text in SummaryFragmentRef", style)
